...
<img src="03.JS基础知识总结.assets/image-20200526233917769.png" alt="image-20200526233917769" style="zoom:50%;" />
...
* 不同点：
  ...
  * call和bind传参方式一样，从第二个参数开始直接传入，apply传参的第二个参数是数组，所传参数放在数组里。
...
![image-20200525182654728](03.JS基础知识总结.assets/image-20200525182654728.png)
